...
- Application source: chưa khởi tạo.
- Last synchronized merge: chưa có.
...
|---|---|---|---|---|---|
| Chưa có | Foundation đang PLANNED | — | — | DOCS_ONLY | — |
...
|---|---|---|---|---|---|
| — | — | Baseline planning | Chưa có application merge | YES | Chờ nhóm review |
