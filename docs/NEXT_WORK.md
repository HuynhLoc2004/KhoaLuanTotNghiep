...
| TASK-AUTH-001 | Keycloak IAM Docker Server, JWT Auth, User Profile, Bookmarks và History MVP | DONE | `loc` / `feature/TASK-AUTH-001` | VerifiedAt: 2026-08-12; MergedAt: 2026-08-12; merge `8e76271`; PR `#12` | TASK-FOUND-001 (DONE), TASK-API-001 (DONE), TASK-DATA-001 (DONE), TASK-SEARCH-001 (DONE) | 3–5 person-days, HIGH | Auth module/contracts/API/UI/Web, `infra/compose.yaml`, `docs/work/TASK-AUTH-001.md` | `docs/work/TASK-AUTH-001.md`; Merge Memory Sync PASS |
| TASK-DASHBOARD-001 | Dashboard Quản lý & Phân tích Analytics MVP | DONE | `loc` / `feature/TASK-DASHBOARD-001` | VerifiedAt: 2026-08-12; MergedAt: 2026-08-12; merge `1439807`; PR `#13` | TASK-FOUND-001 (DONE), TASK-ADMIN-001 (DONE), TASK-AUTH-001 (DONE) | 3–5 person-days, MEDIUM | Dashboard modules/contracts/API/UI/Admin, `docs/work/TASK-DASHBOARD-001.md` | `docs/work/TASK-DASHBOARD-001.md`; Merge Memory Sync PASS |
...
| TASK-VOICE-001 | Multilingual Audio Guide & Voice Command MVP | DONE | `thanh` / `feature/TASK-VOICE-001` | VerifiedAt: 2026-09-02 (thanh tự test `/voice` trên trình duyệt thật); MergedAt: 2026-09-02; merge `1bbbe07`; PR `#20` | TASK-WEB-001 (DONE), TASK-API-001 (DONE) | 4–7 person-days, MEDIUM; actual effort chưa được team cung cấp | `packages/contracts/src/voice/**`, `services/api/src/voice/**`, `services/api/src/routes/voice.ts`, `services/api/test/voice*.ts`, `packages/ui/src/voice/**`, `apps/web/src/voice/**`, `docs/work/TASK-VOICE-001.md` | `docs/work/TASK-VOICE-001.md`; Merge Memory Sync PASS |
| TASK-RECOGNITION-001 | Artifact Photo Recognition AI Pipeline MVP | IN_PROGRESS | `thanh` / `feature/TASK-RECOGNITION-001` | ClaimedAt: 2026-09-02T03:39:02+07:00 | TASK-API-001 (DONE), TASK-DATA-001 (DONE) | 5–8 person-days, MEDIUM | `packages/contracts/src/recognition/**`, `services/api/src/recognition/**`, `services/api/src/routes/recognition.ts`, `services/api/test/recognition*.ts`, `packages/ui/src/recognition/**`, `apps/web/src/recognition/**`, `docs/work/TASK-RECOGNITION-001.md`; không sửa shared status/index/catalog files hoặc root tooling trên feature branch | `docs/work/TASK-RECOGNITION-001.md`; `DEC-RECOGNITION-001`; PLAN-0041 |
...
`TASK-RECOGNITION-001` đã được `thanh` claim trên `feature/TASK-RECOGNITION-001` ngay sau khi Voice merge; `DEC-RECOGNITION-001` sẽ khóa phương án kỹ thuật cụ thể cho MVP embedding retrieval (đã định hướng ở baseline: embedding retrieval + top-k/confidence, pgvector là target vector store dài hạn theo `docs/01-architecture/02-technology-decisions.md`).

- Còn 2 task `READY`: `TASK-LOCATION-001` và `TASK-CMS-MEDIA-001` (đề xuất `loc`).
