...
| TASK-DASHBOARD-001 | Dashboard Quản lý & Phân tích Analytics MVP | IN_PROGRESS | `loc` / `feature/TASK-DASHBOARD-001` | ClaimedAt: 2026-08-12T16:56:00+07:00 | TASK-FOUND-001 (DONE), TASK-ADMIN-001 (DONE), TASK-AUTH-001 (DONE) | 3–5 person-days, MEDIUM | Dashboard modules/contracts/API/UI/Admin, `docs/work/TASK-DASHBOARD-001.md` | `docs/03-features/08-dashboard-analytics.md` |
