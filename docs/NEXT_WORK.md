...
| TASK-AI-GUIDE-001 | Trợ Lý Thuyết Minh Viên AI & Hỏi Đáp Di Sản MVP | IN_PROGRESS | `loc` / `feature/TASK-AI-GUIDE-001` | ClaimedAt: 2026-08-17T09:54:00+07:00 | TASK-FOUND-001 (DONE), TASK-API-001 (DONE), TASK-AUTH-001 (DONE) | 5–8 person-days, MEDIUM | AI modules/contracts/API/UI/Web, `docs/work/TASK-AI-GUIDE-001.md` | `docs/03-features/03-ai-tour-guide.md` |
