...
| FIX-LINT-001 | Sửa toàn bộ lỗi ESLint trong contracts, UI, web, admin và api packages | DONE | `thanh` / `fix/workspace-lint` | VerifiedAt: 2026-08-03T22:08:15+07:00; MergedAt: 2026-08-03; merge `cc1c600` | Codebase baseline merged | O/E/P: 0.5 person-days, LOW; actual effort 0.1 person-days | `packages/contracts/**`, `packages/ui/**`, `apps/web/**`, `apps/admin/**`, `services/api/**`, `docs/work/FIX-LINT-001.md`; không sửa shared status files/root tooling | `docs/work/FIX-LINT-001.md`; Merge Memory Sync PASS |
