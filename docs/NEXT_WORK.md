...
| TASK-WEB-001 | Public Web shell + design tokens + CMS renderer skeleton | IN_PROGRESS | `thanh` / `feature/TASK-WEB-001` | ClaimedAt: 2026-08-03T21:28:52+07:00 | TASK-FOUND-001 (DONE), TASK-API-001 (IMPLEMENTED) | 2–4 person-days, LOW | `apps/web/**`, `packages/ui/**` | `docs/04-design/01-ui-ux-design-system.md` |
