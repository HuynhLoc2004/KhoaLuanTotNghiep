...
| FIX-LINT-001 | Sửa toàn bộ lỗi ESLint trong contracts, UI, web, admin và api packages | IN_PROGRESS | `thanh` / `fix/workspace-lint` | ClaimedAt: 2026-08-03T22:02:24+07:00 | Codebase baseline merged | 0.5 person-days, LOW | `packages/contracts/**`, `packages/ui/**`, `apps/web/**`, `apps/admin/**`, `services/api/**`, `docs/work/FIX-LINT-001.md` | `docs/work/FIX-LINT-001.md` |
