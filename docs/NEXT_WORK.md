...
| TASK-ADMIN-001 | Admin shell + navigation + CMS form foundation | IN_PROGRESS | `thanh` / `feature/TASK-ADMIN-001` | ClaimedAt: 2026-08-03T21:45:02+07:00 | TASK-FOUND-001 (DONE), TASK-API-001 (DONE) | 2–4 person-days, LOW | `apps/admin/**`, CMS contracts | `docs/03-features/01-admin-cms.md` |
...
| TASK-DATA-001 | PostgreSQL migration foundation và entity baseline | READY | Chưa có | — | TASK-FOUND-001 (DONE), TASK-API-001 (DONE) | 2–4 person-days, LOW | migrations, schema, seed foundation | `docs/02-data/01-data-model.md` |
