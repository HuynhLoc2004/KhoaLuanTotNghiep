...
| TASK-3D-NAV-001 | Mô Phỏng Không Gian 3D & Xoay Hiện Vật 360° MVP (Digital Twin) | IN_PROGRESS | `loc` / `feature/TASK-3D-NAV-001` | ClaimedAt: 2026-08-17T16:00:00+07:00 | TASK-WEB-001 (DONE), TASK-TIMELINE-001 (DONE) | 6–9 person-days, MEDIUM | 3D modules/contracts/API/UI/Web, `docs/work/TASK-3D-NAV-001.md` | `docs/03-features/02-web-3d-navigation.md` |
