...
| TASK-ADMIN-001 | Admin shell + navigation + CMS form foundation | READY | Chưa có | — | TASK-FOUND-001 (DONE), TASK-API-001 (DONE) | 2–4 person-days, LOW | `apps/admin/**`, CMS contracts | `docs/03-features/01-admin-cms.md` |
