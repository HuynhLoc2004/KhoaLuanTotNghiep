...
| TASK-TIMELINE-001 | MVP Dòng thời gian sống: free/guided modes, related artifacts, CMS graph, public API và timeline 2D | IN_PROGRESS | `thanh` / `feature/TASK-TIMELINE-001` | ClaimedAt: 2026-08-03T21:53:41+07:00 | TASK-FOUND-001 (DONE), TASK-WEB-001 (DONE), TASK-ADMIN-001 (DONE), TASK-API-001 (DONE), TASK-DATA-001 (DONE) | 9/18/36 person-days, LOW | Shared QR/mode/relation contract; Narrative/Artifact modules; Admin journey/relation editor; Public free/timeline UX; `docs/work/TASK-TIMELINE-001.md` | `docs/03-features/11-living-timeline.md` |
