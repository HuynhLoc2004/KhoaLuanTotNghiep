      ...
      <div style="margin-bottom: 1.75rem;">
        <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.4rem;">
          <span style="font-size: 0.72rem; font-weight: 700; color: var(--color-primary); letter-spacing: 0.05em; text-transform: uppercase;">
            CỔNG QUẢN TRỊ ADMIN / SƠ ĐỒ MẶT BẰNG & DẪN ĐƯỜNG
          </span>
        ...
        <h1 style="font-size: 1.75rem; font-weight: 800; color: var(--color-text-main); margin: 0 0 0.25rem 0;">
          Quản Lý Sơ Đồ Kiến Trúc & Cầu Nối Phân Luồng
        </h1>
        ...
        <div class="card" style="border-top: 4px solid var(--color-secondary);">
          ...
          <form id="map-room-config-form">
            ...
            <div style="margin-bottom: 0.85rem;">
              ...
              <input type="text" id="admin-map-room-name" class="lang-select" style="width: 100%; padding: 0.65rem;" placeholder="VD: Sảnh Điêu Khắc Sa Thạch" value="Gian Cổ Vật Mới Bổ Sung" />
            </div>

            <!-- 4. Link to 360 Tour Hall (Select) -->
            <div style="margin-bottom: 0.85rem;">
              <label style="font-size: 0.82rem; font-weight: 600; color: var(--color-text-muted); display: block; margin-bottom: 0.3rem;">
                4. Liên Kết Cầu Nối Bay Sang Sảnh 360°:
              </label>
            ...
            <button type="button" class="btn btn-primary" id="btn-save-map-room" style="width: 100%; padding: 0.75rem; justify-content: center;">
              ${Icons.check}
