...
2. Never commit, merge, push, rebase or switch branches unless the user explicitly asks. Proposing exact commands and explaining when to run them is required at handoff or task switching.
