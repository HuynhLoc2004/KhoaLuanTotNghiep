...
export function renderMobileBottomNav(): string {
  return `
    ...
    <nav id="mobile-bottom-nav" class="md:hidden fixed bottom-4 left-4 right-4 z-50 bg-slate-950/92 backdrop-blur-2xl border border-amber-500/35 rounded-2xl px-3 py-2 flex justify-around items-center text-[10px] font-mono shadow-[0_15px_40px_rgba(0,0,0,0.85)]">
      ...
      <a href="/3d-experience" class="flex flex-col items-center gap-1 text-slate-300 hover:text-amber-400 px-2 py-1">
        ...
        <span class="text-cyan-300">3D Twin</span>
      </a>
      
      <!-- Central Camera QR Scanner Floating Action Button -->
      <button class="btn-trigger-qr-scanner -mt-7 w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 via-amber-500 to-rose-600 text-slate-950 font-bold shadow-[0_0_25px_rgba(245,158,11,0.7)] animate-pulse border-2 border-amber-300 flex items-center justify-center">
        <svg class="w-6 h-6 text-slate-950" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z"/></svg>
      </button>

      <a href="/search" class="flex flex-col items-center gap-1 text-slate-300 hover:text-amber-400 px-2 py-1">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
        <span>Tra cứu</span>
      </a>
      <a href="/ai-guide" class="flex flex-col items-center gap-1 text-slate-300 hover:text-amber-400 px-2 py-1">
  ...
  return `
    <footer id="main-footer" class="bg-slate-950/90 border-t border-amber-500/20 text-slate-400 py-12 px-4 sm:px-6 mt-auto mb-20 md:mb-0">
      <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div>
          <h4 class="font-heading text-amber-400 text-sm font-bold uppercase tracking-wider mb-3">Thông tin liên hệ</h4>
        ...
        <div>
          <h4 class="font-heading text-amber-400 text-sm font-bold uppercase tracking-wider mb-3">Liên kết nhanh</h4>
      ...
      <div class="border-t border-slate-800/80 pt-6 text-center text-xs font-mono text-slate-500">
